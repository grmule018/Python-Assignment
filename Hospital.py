...
class Hospital:
    ...
    #========================================================DataFrameLEFT=================================================================================
        ...
        self.lblDUseMachine =Label(DataFrameLEFT, font=('arial', 12,'bold'), text="Machine:",padx=2,pady=2)
        ...
        text="Name of Tablets\tReference No.\t Dosage\t No. of Tablets\t Lot\t Issued Date\t Exp.Date\
